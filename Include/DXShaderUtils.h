...
namespace A2D {
	...
	public:
		...
		static HRESULT					LoadEffectFromFile(LPCWSTR xFilename, ID3D10Device * xDXDevice, ID3D10Effect ** xEffect);

		// Create Alpha transpareny supportable PNG
		static HRESULT					CreatePNGCompatibleBlendStates(ID3D10Device * xDXDevice, ID3D10BlendState ** xBlendState, ID3D10BlendState ** xBlendDisabledState);
