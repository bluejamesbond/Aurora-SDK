...
A2DTextureBuffer::A2DTextureBuffer(A2DBackBuffer * xBackBuffer, float xWidth, float xHeight) :
...
HRESULT A2DTextureBuffer::Initialize()
{
	...
	textureDesc.Width = (int) aWidth;
	textureDesc.Height = (int)aHeight;
...
ID3D10ShaderResourceView * A2DTextureBuffer::GetResource()
{
	return aResource;
}
